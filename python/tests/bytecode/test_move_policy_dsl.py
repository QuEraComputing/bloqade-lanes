"""End-to-end smoke test: PolicyRunner.solve(...) routes through the Move
Policy DSL kernel and returns a PolicySolveResult with DSL fields."""
...
class TestPolicyRunnerSolve:
    def test_returns_policy_solve_result(self):
        ...
        try:
            ...
            assert isinstance(result, PolicySolveResult)
        finally:
