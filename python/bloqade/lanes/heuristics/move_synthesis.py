        ...
        for src, dst in cross_word:
            ...
            for wb_site in candidate_sites:
                if wb_site not in arch_spec.has_word_buses:
                    continue
                wb_src = layout.LocationAddress(0, src.word_id, wb_site)
                wb_dst = layout.LocationAddress(0, dst.word_id, wb_site)
