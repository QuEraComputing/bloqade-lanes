...
class PostSelectionExperimentCache:
    ...
    decoders_with_confidence: (
        tuple[DecoderAdapter, DecoderAdapter, DecoderAdapter] | None
    )
...
class PostSelectionExperiment:
    ...
    def initialize_decoders(
        ...
        for dem_base in dems_bases:
            ...
            decoders_bases.append((full_decoder, factory_decoder))
        decoders_bases = tuple(decoders_bases)
        self.postselection_exp_cache.decoders = decoders_bases
        return decoders_bases

    def prep_decoders(self) -> tuple[DecoderAdapter, DecoderAdapter, DecoderAdapter]:
        ...
        actual_circuits = tuple(act_task.tsim_circuit for act_task in actual_tasks)
