...
from bloqade.decoders import BaseDecoder, GurobiDecoder
...
# TODO: ideally, we can just inherit from ConfidenceDecoder and ConfidenceDecoder can
# inherit from BaseDecoder
@dataclass(frozen=True)
class TableDecoderWithConfidence(BaseDecoder, ConfidenceDecoder):
